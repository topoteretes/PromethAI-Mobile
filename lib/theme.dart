...
final theme = ThemeData(
  ...
  textTheme: const TextTheme(
    bodyLarge: TextStyle(fontSize: 18, height: 1.4202273233, fontWeight: FontWeight.normal, color: C.black),
    ...
    titleMedium: TextStyle(fontSize: 16, height: 1.2125, fontWeight: FontWeight.w700, color: C.black),
    titleLarge: TextStyle(fontSize: 24, height: 28 / 24, fontWeight: FontWeight.w700, color: C.black),
    titleSmall: TextStyle(fontSize: 18, height: 1, fontWeight: FontWeight.bold, color: C.front),
    ...
    labelSmall: TextStyle(fontSize: 10, height: 1, fontWeight: FontWeight.w600, color: C.grey3),
