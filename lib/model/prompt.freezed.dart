...
abstract class $PromptCopyWith<$Res> {
  ...
  @useResult
  $Res call({String original, String current, List<String> changed, Map<String, String> originalMap, bool updating});
}
...
abstract class _$$_PromptCopyWith<$Res> implements $PromptCopyWith<$Res> {
  factory _$$_PromptCopyWith(_$_Prompt value, $Res Function(_$_Prompt) then) = __$$_PromptCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String original, String current, List<String> changed, Map<String, String> originalMap, bool updating});
}
...
/// @nodoc
class __$$_PromptCopyWithImpl<$Res> extends _$PromptCopyWithImpl<$Res, _$_Prompt> implements _$$_PromptCopyWith<$Res> {
  __$$_PromptCopyWithImpl(_$_Prompt _value, $Res Function(_$_Prompt) _then) : super(_value, _then);
...
class _$_Prompt implements _Prompt {
  ...
  factory _$_Prompt.fromJson(Map<String, dynamic> json) => _$$_PromptFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._originalMap, _originalMap) &&
            (identical(other.updating, updating) || other.updating == updating));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, original, current, const DeepCollectionEquality().hash(_changed),
      const DeepCollectionEquality().hash(_originalMap), updating);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_PromptCopyWith<_$_Prompt> get copyWith => __$$_PromptCopyWithImpl<_$_Prompt>(this, _$identity);
...
abstract class _Prompt implements Prompt {
  ...
  @override
  @JsonKey(ignore: true)
  _$$_PromptCopyWith<_$_Prompt> get copyWith => throw _privateConstructorUsedError;
}
