...
_$_ReplicateResponse _$$_ReplicateResponseFromJson(Map<String, dynamic> json) => _$_ReplicateResponse(
...
Map<String, dynamic> _$$_ReplicateResponseToJson(_$_ReplicateResponse instance) => <String, dynamic>{
      'id': instance.id,
