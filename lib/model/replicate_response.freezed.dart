...
mixin _$ReplicateResponse {
  ...
  @JsonKey(ignore: true)
  $ReplicateResponseCopyWith<ReplicateResponse> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ReplicateResponseCopyWith<$Res> {
  factory $ReplicateResponseCopyWith(ReplicateResponse value, $Res Function(ReplicateResponse) then) =
...
/// @nodoc
class _$ReplicateResponseCopyWithImpl<$Res, $Val extends ReplicateResponse> implements $ReplicateResponseCopyWith<$Res> {
...
/// @nodoc
abstract class _$$_ReplicateResponseCopyWith<$Res> implements $ReplicateResponseCopyWith<$Res> {
  factory _$$_ReplicateResponseCopyWith(_$_ReplicateResponse value, $Res Function(_$_ReplicateResponse) then) =
...
/// @nodoc
class __$$_ReplicateResponseCopyWithImpl<$Res> extends _$ReplicateResponseCopyWithImpl<$Res, _$_ReplicateResponse>
    implements _$$_ReplicateResponseCopyWith<$Res> {
  __$$_ReplicateResponseCopyWithImpl(_$_ReplicateResponse _value, $Res Function(_$_ReplicateResponse) _then) : super(_value, _then);
...
class _$_ReplicateResponse implements _ReplicateResponse {
  ...
  factory _$_ReplicateResponse.fromJson(Map<String, dynamic> json) => _$$_ReplicateResponseFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, version, input, logs, const DeepCollectionEquality().hash(_error),
      const DeepCollectionEquality().hash(_output), status, createdAt, completedAt, urls);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_ReplicateResponseCopyWith<_$_ReplicateResponse> get copyWith =>
      __$$_ReplicateResponseCopyWithImpl<_$_ReplicateResponse>(this, _$identity);
...
abstract class _ReplicateResponse implements ReplicateResponse {
  ...
  factory _ReplicateResponse.fromJson(Map<String, dynamic> json) = _$_ReplicateResponse.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$$_ReplicateResponseCopyWith<_$_ReplicateResponse> get copyWith => throw _privateConstructorUsedError;
}
