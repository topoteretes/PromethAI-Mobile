...
mixin _$PromptDecomposeRequest {
  ...
  @JsonKey(name: 'user_defaults')
  String get userDefaults => throw _privateConstructorUsedError;
...
abstract class $PromptDecomposeRequestCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'user_defaults') String userDefaults,
      String prompt});
}
    ...
    return _then(_value.copyWith(
      ...
      sessionId: null == sessionId
          ...
          : sessionId // ignore: cast_nullable_to_non_nullable
              as String,
      userDefaults: null == userDefaults
          ? _value.userDefaults
          : userDefaults // ignore: cast_nullable_to_non_nullable
              as String,
      prompt: null == prompt
          ? _value.prompt
...
class _$_PromptChooseRequest implements _PromptChooseRequest {
  const _$_PromptChooseRequest(
      ...
      @JsonKey(name: 'user_defaults') required this.userDefaults,
  ...
  @override
  @JsonKey(name: 'user_defaults')
  final String userDefaults;
  @override
  final String prompt;

  @override
  String toString() {
    return 'PromptDecomposeRequest(modelSpeed: $modelSpeed, userId: $userId, sessionId: $sessionId, userDefaults: $userDefaults, prompt: $prompt)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.userDefaults, userDefaults) ||
  ...
  int get hashCode => Object.hash(
      runtimeType, modelSpeed, userId, sessionId, userDefaults, prompt);
...
abstract class _PromptChooseRequest implements PromptDecomposeRequest {
  const factory _PromptChooseRequest(
      ...
      @JsonKey(name: 'user_defaults') required final String userDefaults,
