...
mixin _$ReplicateRequest {
  ...
  @JsonKey(ignore: true)
  $ReplicateRequestCopyWith<ReplicateRequest> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ReplicateRequestCopyWith<$Res> {
  factory $ReplicateRequestCopyWith(ReplicateRequest value, $Res Function(ReplicateRequest) then) =
...
/// @nodoc
class _$ReplicateRequestCopyWithImpl<$Res, $Val extends ReplicateRequest> implements $ReplicateRequestCopyWith<$Res> {
...
/// @nodoc
abstract class _$$_ReplicateRequestCopyWith<$Res> implements $ReplicateRequestCopyWith<$Res> {
  factory _$$_ReplicateRequestCopyWith(_$_ReplicateRequest value, $Res Function(_$_ReplicateRequest) then) =
...
/// @nodoc
class __$$_ReplicateRequestCopyWithImpl<$Res> extends _$ReplicateRequestCopyWithImpl<$Res, _$_ReplicateRequest>
    implements _$$_ReplicateRequestCopyWith<$Res> {
  __$$_ReplicateRequestCopyWithImpl(_$_ReplicateRequest _value, $Res Function(_$_ReplicateRequest) _then) : super(_value, _then);
...
class _$_ReplicateRequest implements _ReplicateRequest {
  ...
  factory _$_ReplicateRequest.fromJson(Map<String, dynamic> json) => _$$_ReplicateRequestFromJson(json);
...
abstract class _ReplicateRequest implements ReplicateRequest {
  const factory _ReplicateRequest({required final String version, required final PromptInput input}) = _$_ReplicateRequest;

  factory _ReplicateRequest.fromJson(Map<String, dynamic> json) = _$_ReplicateRequest.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$$_ReplicateRequestCopyWith<_$_ReplicateRequest> get copyWith => throw _privateConstructorUsedError;
}
