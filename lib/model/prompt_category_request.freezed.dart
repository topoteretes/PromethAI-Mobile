...
PromptCategoryRequest _$PromptCategoryRequestFromJson(Map<String, dynamic> json) {
...
mixin _$PromptCategoryRequest {
  ...
  @JsonKey(ignore: true)
  $PromptCategoryRequestCopyWith<PromptCategoryRequest> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PromptCategoryRequestCopyWith<$Res> {
  factory $PromptCategoryRequestCopyWith(PromptCategoryRequest value, $Res Function(PromptCategoryRequest) then) =
...
/// @nodoc
class _$PromptCategoryRequestCopyWithImpl<$Res, $Val extends PromptCategoryRequest> implements $PromptCategoryRequestCopyWith<$Res> {
...
/// @nodoc
abstract class _$$_PromptCategoryRequestCopyWith<$Res> implements $PromptCategoryRequestCopyWith<$Res> {
  factory _$$_PromptCategoryRequestCopyWith(_$_PromptCategoryRequest value, $Res Function(_$_PromptCategoryRequest) then) =
...
/// @nodoc
class __$$_PromptCategoryRequestCopyWithImpl<$Res> extends _$PromptCategoryRequestCopyWithImpl<$Res, _$_PromptCategoryRequest>
    implements _$$_PromptCategoryRequestCopyWith<$Res> {
  __$$_PromptCategoryRequestCopyWithImpl(_$_PromptCategoryRequest _value, $Res Function(_$_PromptCategoryRequest) _then)
      : super(_value, _then);
...
class _$_PromptCategoryRequest implements _PromptCategoryRequest {
  ...
  factory _$_PromptCategoryRequest.fromJson(Map<String, dynamic> json) => _$$_PromptCategoryRequestFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.promptStruct, promptStruct) || other.promptStruct == promptStruct));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, modelSpeed, userId, sessionId, promptStruct);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_PromptCategoryRequestCopyWith<_$_PromptCategoryRequest> get copyWith =>
      __$$_PromptCategoryRequestCopyWithImpl<_$_PromptCategoryRequest>(this, _$identity);
...
abstract class _PromptCategoryRequest implements PromptCategoryRequest {
  const factory _PromptCategoryRequest(
      ...
      @JsonKey(name: 'prompt_struct') required final String promptStruct}) = _$_PromptCategoryRequest;

  factory _PromptCategoryRequest.fromJson(Map<String, dynamic> json) = _$_PromptCategoryRequest.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$$_PromptCategoryRequestCopyWith<_$_PromptCategoryRequest> get copyWith => throw _privateConstructorUsedError;
}
